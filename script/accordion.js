...
(function () {
    let ACCORDION = {
        ...
        insertData: function () {
            dataAccordion.forEach(item => {
                document.querySelector('.main-accordion-container').insertAdjacentHTML("beforeend", this.tplAccordionItem(item));
                console.log('Inserted accordion item:', item.title); // Verifica la inserción
            });
        },

        eventhandler: function () {
            // Asigna los eventos después de que los elementos hayan sido insertados
        ...
        showTab: function (refItem) {
            ...
            if (activeTab && activeTab !== refItem.parentElement) {
